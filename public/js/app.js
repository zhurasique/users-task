...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    loadCountries: function loadCountries() {
      ...
      $.ajax({
        ...
        for (var i = 0; i < data['data'].length; i++) {
          _this.countries.push(data['data'][i]);
        }
    ...
    decCurrentPage: function decCurrentPage() {
      this.current_page--;
      this.displayUser();
    },
      ...
      _c("div", { staticClass: "form-group" }, [
        ...
        _c("input", {
          ...
          attrs: {
            type: "email",
            name: "email",
            placeholder: "alfred.nobel@gmail.com"
          },
      ...
      _c("div", { staticClass: "form-group", attrs: { id: "country" } }, [
        ...
        _c(
          ...
          _vm._l(_vm.countries, function(country) {
            return _c("option", {
              key: country.id,
              domProps: { value: country, textContent: _vm._s(country.name) }
            })
          }),
          0
        )
      ...
      _c(
        ...
        _vm._l(_vm.users, function(user) {
          return _c(
            ...
            { key: user.id },
            [
              _c("th", { domProps: { textContent: _vm._s(user.name) } }),
              _vm._v(" "),
              ...
              _vm._l(_vm.countries, function(country) {
                return user.country_id === country.id
                  ? _c("td", {
                      key: country.id,
                      domProps: { textContent: _vm._s(country.name) }
                    })
                  : _vm._e()
              }),
              _vm._v(" "),
...
Vue.component('front-page', __webpack_require__(/*! ./components/Form.vue */ "./resources/js/components/Form.vue")["default"]);
var form = new Vue({
  el: '#form'
});
...
__webpack_require__(/*! C:\Users\666\PhpstormProjects\users\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Users\666\PhpstormProjects\users\resources\sass\app.scss */"./resources/sass/app.scss");
